...
const AllFilesDialog = ({
  ...
  const convex: any = useConvex();
  // Relax typing for local/OSS setup where Convex schema may not be present.
  const getFileUrlAction: any = useAction(api.s3Actions.getFileUrlAction);
